...
public class GambitRequestClientSecret extends GambitRequest {
    ...
    public static class Builder {
        ...
        */
         ...
         * @return An instance of {@link GambitRequestClientSecret} generated by this {@link Builder}
         */
        public GambitRequestClientSecret build() {
            return new GambitRequestClientSecret(this);
        }
    }
     ...
     */
    protected static final String endpoint = "client_secret";
     ...
     */
    protected GambitRequestClientSecret(Builder builder) {
    ...
    protected URL getUrl() throws IOException {
        ...
        try {
            ...
            throw new CogsException("Invalid format for client secret request URL.", ex);
        }
    ...
    protected void setRequestParams(HttpURLConnection connection) {
        try {
            ...
            throw new CogsException("Error setting request parameters for client secret request.", ex);
        }
    }

    /**
     * Build {@link GambitResponseClientSecret} instance, containing the client salt and secret hashes generated by
     * Gambit to be used later with the Gambit SDK library.
     * @param response The RAW HTTP response body as text
     * @param code The RAW HTTP response code as an integer
     * @return An instance of {@link GambitResponseClientSecret}
     */
    @Override
    protected GambitResponse getResponse(String response, int code) {
        return new GambitResponseClientSecret(response, code);
    }
